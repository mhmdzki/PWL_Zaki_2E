        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    ...
                    <input value="{{ $barang->harga_beli }}" type="text" name="harga_beli" id="harga_beli" class="form-control" required inputmode="numeric" pattern="[0-9]*">
                    <small id="error-harga_beli" class="error-text form-text text-danger"></small>
                </div>
                <div class="form-group">
                    <label>Harga Jual</label>
                    <input value="{{ $barang->harga_jual }}" type="text" name="harga_jual" id="harga_jual" class="form-control" required inputmode="numeric" pattern="[0-9]*">
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        if(response.status){
                            ...
                            $('#table_barang').DataTable().ajax.reload(); // Refresh the DataTable
                        }else{  
                            $('.error-text').text('');
