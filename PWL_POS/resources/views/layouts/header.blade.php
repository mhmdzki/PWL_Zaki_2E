...
<li class="nav-item dropdown">
  <a href="#" class="nav-link dropdown-toggle d-flex align-items-center" data-toggle="dropdown">
    ...
    <span class="ml-2 d-none d-md-inline text-capitalize">{{ Auth::user()->nama }}</span>
  </a>
  ...
  <div class="dropdown-menu dropdown-menu-right shadow-lg rounded">
    ...
    <div class="dropdown-header d-flex align-items-center">
      ...
      <div>
        ...
        <small class="text-muted text-capitalize">{{ Auth::user()->level->level_nama ?? 'Pengguna' }}</small>
      </div>
    </div>
    ...
    <a href="{{ url('/profile') }}" class="dropdown-item">
      <i class="fas fa-user mr-2 text-primary"></i> Lihat Profil
    </a>
